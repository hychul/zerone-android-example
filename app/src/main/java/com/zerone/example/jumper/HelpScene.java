...
public class HelpScene extends ActScene {
    ...
    public HelpScene(ZeroneActivity zerone) {
        super(zerone);
    }
    ...
    public void onResume() {
        helpImage = new Texture(zerone.getFileIO(), "jumper/help1.png");
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (event.phase == TouchEvent.TOUCH_UP) {
                if (OverlapTester.pointInRectangle(nextBounds, touchPoint)) {
                    ...
                    SceneManager.INSTANCE.loadScene(new HelpScene2(zerone));
                    return;
                }
            }
        }
